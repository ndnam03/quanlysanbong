...
public class ChamCongView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Xác Nhân Đi Làm");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ChamCong chamCong  = ChamCong.builder()
                .idNhanVien(Integer.parseInt(jTextField1.getText()))
                .ngayLam(new Date())
                .build();
        System.out.println(jTextField1.getText());
        boolean f = chamCongService.add(chamCong);
        if(f){
